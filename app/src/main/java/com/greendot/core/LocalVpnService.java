...
import com.greendot.core.ProxyConfig.IPAddress;
import com.greendot.dns.DnsPacket;
import com.greendot.tcpip.CommonMethods;
import com.greendot.tcpip.IPHeader;
import com.greendot.tcpip.TCPHeader;
import com.greendot.tcpip.UDPHeader;
import com.greendot.ui.MainActivity;
...
public class LocalVpnService extends VpnService implements Runnable {
    ...
    private ParcelFileDescriptor establishVPN() throws Exception {
        ...
        onStatusChanged(ProxyConfig.Instance.getSessionName() + getString(R.string.connected_text), true);
    ...
    public void disconnectVPN() {
        ...
        onStatusChanged(ProxyConfig.Instance.getSessionName() + getString(R.string.disconnected_text), false);
